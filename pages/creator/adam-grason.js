...
import artworks from '../../artworks/adam-grason';
import transcript from '../../transcripts/adam-grason';
import creators from '../../data/creators.json';

const creator = creators.find(item => (item.slug === 'adam-grason'));
const pageTitle = 'Adam Grason Interview (Episode 005)';
